...
(function ($) {
  ...
  var ORBIT = {
    ...
    bulletHTML: '<ul class="orbit-bullets visible-desktop"></ul>',
    ...
    addBullet: function (index, slide) {
	  ...
	  var thumbTitle = $(slide).attr('data-title');
	  
      var position = index + 1,
      	
          $li = $('<li class="span3"><i class="icon-caret-down"></i>' + '<h5>' + (thumbTitle) + '</h5>' + '</li>'),
          thumbName,
          self = this;
